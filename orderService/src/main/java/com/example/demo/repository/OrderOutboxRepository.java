...
public interface OrderOutboxRepository extends JpaRepository<OrderOutbox, String> {
    ...
    @Query("SELECT o FROM OrderOutbox o WHERE o.processed = false AND o.retryCount < 5 ORDER BY o.createdAt ASC")
    List<OrderOutbox> findUnprocessedOutboxEvents();
    ...
    List<OrderOutbox> findByAggregateIdOrderByCreatedAtAsc(String aggregateId);
